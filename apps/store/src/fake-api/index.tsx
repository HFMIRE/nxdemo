const games = [
  {
    ...
    image: '/assets/bean.jpg', // https://media.giphy.com/media/xUNda3pLJEsg4Nedji/giphy.gif,
    description:
  ...
  },
  {
    id: 'chess-pie',
    name: 'Chess Pie',
    image: '/assets/chess.jpg', // 'https://media.giphy.com/media/iCZyBnPBLr0dy/giphy.gif',
  ...
  },
  {
    id: 'purrfection',
    name: 'Purrfection',
    image: '/assets/cat.jpg', // 'https://media.giphy.com/media/12xMvwvQXJNx0k/giphy.gif',
